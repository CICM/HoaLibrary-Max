...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 380.0, 329.0, 176.618362, 39.0 ],
									"presentation_rect" : [ 380.0, 329.0, 176.618362, 39.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 333.333374, 187.0, 55.0, 21.0 ],
									"style" : "",
									"text" : "hoa.pi 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 409.333374, 231.0, 50.0, 21.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 409.333374, 264.0, 70.0, 21.0 ],
									"style" : "",
									"text" : "pack 0. 100"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 409.333374, 289.0, 36.0, 22.0 ],
									"style" : "",
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 44.000008, 329.0, 329.0, 21.0 ],
									"style" : "",
									"text" : "hoa.2d.wider~ 7"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 15,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 44.0, 230.0, 308.333374, 21.0 ],
									"style" : "",
...
,
									"patching_rect" : [ 443.0, 121.0, 51.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 443.0, 151.0, 74.0, 21.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 333.333374, 151.0, 50.0, 21.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 44.0, 127.0, 221.0, 93.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 4,
									"numoutlets" : 0,
									"patching_rect" : [ 421.0, 22.5, 52.0, 25.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 409.333374, 197.0, 73.0, 21.0 ],
									"style" : "",
									"text" : "loadmess 1."
								}
...
,
					"patching_rect" : [ 16.0, 26.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.595187,
...
,
					"patching_rect" : [ 67.0, 26.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-34::obj-1::obj-35" : [ "[5]", "Level", 0 ],
			"obj-34::obj-1::obj-21::obj-6" : [ "live.tab[3]", "live.tab[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "demosound.maxpat",
