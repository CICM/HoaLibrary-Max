...
,
					"patching_rect" : [ 577.0, 173.440063, 98.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 111.0, 242.0, 110.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 111.0, 115.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 66.0, 82.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 55.0, 50.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 82.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "i"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 277.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 182.5, 32.5, 21.0 ],
									"style" : "",
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.5, 182.5, 86.0, 34.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 15.0, 151.0, 62.5, 21.0 ],
									"style" : "",
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 242.0, 62.5, 21.0 ],
									"style" : "",
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 209.5, 32.5, 21.0 ],
									"style" : "",
									"text" : "/ 2"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 18.0, 140.0, 48.0, 22.0 ],
									"style" : "",
									"text" : "pack i i"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 89.0, 56.0, 52.0, 21.0 ],
									"style" : "",
									"text" : "t b i b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 18.0, 189.0, 89.0, 21.0 ],
									"style" : "",
									"text" : "target $1 $2, 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 122.0, 189.0, 71.0, 21.0 ],
									"style" : "",
									"text" : "target all, 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 18.0, 56.0, 32.5, 21.0 ],
									"style" : "",
									"text" : "t i b"
								}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Représentation des harmoniques sphériques",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 649.0, 231.440063, 20.0, 22.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 544.0, 232.940063, 45.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 591.0, 231.440063, 56.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 411.0, 258.440063, 42.0, 21.0 ],
					"style" : "",
					"text" : "sig~ 1"
				}
...
,
					"patching_rect" : [ 591.0, 258.440063, 78.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 411.0, 324.940063, 258.0, 258.0 ]
				}
...
,
					"patching_rect" : [ 567.949951, 110.0, 69.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.5, 112.440063, 54.0, 32.0 ],
					"style" : "",
					"text" : "Audio\nOn/Off",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 105.940063, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 102.940063, 120.0, 51.0 ],
					"proportion" : 0.39,
					"rounded" : 6,
					"shadow" : -1,
					"style" : ""
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 102.940063, 370.0, 71.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.049988, 226.440063, 272.899963, 364.059937 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 600.5, 285.940063, 420.5, 285.940063 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 577.449951, 132.0, 577.449951, 132.0 ],
					"source" : [ "obj-46", 0 ]
				}
