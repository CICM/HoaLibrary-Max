...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 395.5, 466.5, 54.0, 32.0 ],
					"style" : "",
					"text" : "Audio\nOn/Off",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 460.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 457.0, 120.0, 51.0 ],
					"proportion" : 0.39,
					"rounded" : 6,
					"shadow" : -1,
					"style" : ""
...
,
					"patching_rect" : [ 629.0, 126.0, 76.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.0, 156.0, 74.0, 21.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 245.5, 65.0, 22.0 ],
					"style" : "",
					"text" : "set charlie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 245.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "set tango"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 533.0, 281.5, 170.0, 49.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.4375, 73.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.4375, 101.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
