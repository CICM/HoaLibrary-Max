...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 193.0, 79.0, 19.0 ],
					"style" : "",
					"text" : "<- look inside",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 451.0, 176.5, 176.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 413.0, 176.5, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 201.34375, 148.0, 50.0, 22.0 ],
					"presentation_rect" : [ 605.34375, 167.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 27.0, 231.440063, 173.0, 173.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 185.0, 173.0, 35.0 ],
					"style" : "",
					"text" : "hoa.2d.process~ 7 hoa.fx.wider~ harmonics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 27.0, 148.0, 162.733337, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.049988, 318.440063, 364.0, 149.0 ],
					"style" : "",
					"text" : "This operation consists to multiply each harmonic by a gain g that depends on the decomposition order N, the harmonic degree l and the widening value x :\nif (l == 0)\n    g(x) = b(x) * N + 1\nelse\n    g(x) = (b(x) * N - 1) + 1) * (cos(min(0, max(a(x) * l, π))) + 1) * 0.5\nwith\n    a(x) = (1 - x) * π\nand \n    b(x) = (sin(a(x) - π / 2) + 1) * 0.5",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 143.0, 237.0, 32.0 ],
					"style" : "",
					"text" : "Widening value between 0 (omnidirectional)\nand 1 (the most directional).",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "During the harmonic treatments, we can change the directivity of the sound field. This is one of the underlying operations of the distance compensation algorithm, while the sound enters in the ambisonic sphere or circle.",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "Tutorial 10", "@obj-desc", "Wider" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
