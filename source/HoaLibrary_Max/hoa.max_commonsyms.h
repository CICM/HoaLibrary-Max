...
static t_symbol* hoa_sym_signal                     = gensym("signal");
static t_symbol* hoa_sym_dsp                        = gensym("dsp");
...
static t_symbol* hoa_sym_regular                    = gensym("regular");
...
static t_symbol* hoa_sym_crop                       = gensym("crop");
